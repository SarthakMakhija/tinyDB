...
func (wal *WAL) Write(entry *Entry) error {
	...
	wal.currentWritableOffset = wal.currentWritableOffset + uint64(bytesWritten)
	return nil
}
...
func (wal WAL) CurrentWritableOffset() uint64 {
	return wal.currentWritableOffset
}
