...
func TestPutsAKeyValueAndGetByKeyInMemTable(t *testing.T) {
	memTable, _ := NewMemTable(RandomWALFileId(), option.DefaultOptions().SetDbDirectory("."))
...
func TestMemtableIsFull(t *testing.T) {
	memTable, _ := NewMemTable(RandomWALFileId(), option.DefaultOptions().SetMemtableSizeInBytes(20).SetDbDirectory("."))
	defer memTable.RemoveWAL()
...
func TestMemtableIsFullGivenWALIsFull(t *testing.T) {
	memTable, _ := NewMemTable(RandomWALFileId(), option.DefaultOptions().SetMemtableSizeInBytes(25).SetDbDirectory("."))
	defer memTable.RemoveWAL()
...
func TestMemtableIsNotFull(t *testing.T) {
	memTable, _ := NewMemTable(RandomWALFileId(), option.DefaultOptions().SetMemtableSizeInBytes(32).SetDbDirectory("."))
	defer memTable.RemoveWAL()
